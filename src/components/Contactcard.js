...
function Contactcard({contacts}){
    return(
        <div>
            ...
            <table className="table table-bordered text-center mt-3 w-75 mx-auto">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>Photo</th>
